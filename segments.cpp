...
int split_equal_segments(std::string path, int segments){
    ...
    int dest_file = open("storage.dat", O_RDWR | O_CREAT, SEGMENT_SIZE);
...
int main() {
    std::string filename = "/Users/elizavetaomelcenko/Downloads/S2B_MSIL1C_20230519T075609_N0509_R035_T38UMU_20230519T085529.SAFE/S2B_MSIL1C_20230519T075609_N0509_R035_T38UMU_20230519T085529-ql.jpg";  // Задаем путь к файлу
